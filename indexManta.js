...
const port = process.env.PORT_MANTA || 3005;


//CONSTANTS
const providerUrl = process.env.PROVIDER_URL_MANTA;
const poolfactory = process.env.CONTRACT_POOL_FACTORY_MANTA;
const contract_memefactory= process.env.CONTRACT_MEME_FACTORY_MANTA;
const contract_WETH = process.env.CONTRACT_WETH_MANTA;
...
const checkAddingLiquidity = async (sponsor, token_contract) => {
  ...
  const pairAddress = "TMANTA_"+pre_pairAddress.slice(1);
  try {
